...
export default function AdminStudentPersonalMushafPage({
  params,
}: {
  ...
  return (
    <PermissionGuard permission="mushaf.access">
      <div className="flex h-screen flex-col">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-neutral-600">Full access to student's recitation mistakes</p>
                </div>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <button className="flex items-center gap-2 rounded-lg border border-red-200 bg-white px-4 py-2 text-sm font-medium text-red-700 hover:bg-red-50">
        ...
        {/* Main Content */}
        <PersonalMushafView studentId={params.studentId} mode="admin" studentName={studentName} />
      </div>
    </PermissionGuard>
  );
}
